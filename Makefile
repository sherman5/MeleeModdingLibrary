...
LIBS = libmml_O0.a libmml.a libmml_O2.a libmml_O3.a # libmml_Os.a
DIST_LIBS = libmml_O0.a libmml.a libmml_O2.a libmml_O3.a 
...
test_melee_info test_move test_print test_random test_state_check \
