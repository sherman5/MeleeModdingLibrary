/**
 * @file native_functions_102.h
 * @brief Pointers to in game functions (NTSC 1.02)
 */

#ifndef MML_NATIVE_FUNCTIONS_102_H
#define MML_NATIVE_FUNCTIONS_102_H
...
#define CARD_INIT_FPTR      VOID_PTR(0x803530e4)
